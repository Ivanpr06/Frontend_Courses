# Frontend_Courses 🖥️
In this repository, you will find several courses I completed independently while exploring new aspects of backend programming.

## 💻 Courses 
<ul>
  <li><h3>Courses of JavaScript 📱</h3>
  <img src="https://img.shields.io/badge/JavaScript-black?logo=JavaScript">
  <p>In these courses, you can see some of my first steps learning JavaScript. The initial courses are simpler, focusing on understanding the syntax and how the language works. In the later courses, I worked on more complex exercises, such as a weather application, a to-do list, and even a copy of an Amazon page with a shopping cart. These projects helped me gain a deeper understanding of the most popular tools for web development, which I find incredibly interesting.</p>
  <p><a href="https://www.youtube.com/watch?v=QoC4RxNIs5M">Curso JS desde 0</a></p>
